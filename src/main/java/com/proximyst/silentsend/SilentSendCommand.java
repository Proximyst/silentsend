...
// Mostly copied from:
// https://github.com/SpigotMC/BungeeCord/blob/master/module/cmd-send/src/main/java/net/md_5/bungee/module/cmd/send/CommandSend.java
public final class SilentSendCommand extends Command implements TabExecutor {
...
//        }
  ...
  public SilentSendCommand() // SilentSend - change class name
  {
    super( "silentsend", "silentsend.command" ); // SilentSend
  }
  ...
  public void execute(CommandSender sender, String[] args)
  {
    if ( args.length != 2 )
    {
      sender.sendMessage( ProxyServer.getInstance().getTranslation( "send_cmd_usage" ).replace("send", "silentsend") ); // SilentSend - usage for our command instead
      return;
    }
